# Solipath Deno/Typescript example project
This is a quick showcase of using Solipath for a Deno project
...
If you have an existing deno project, all you should need to do is copy the solipath, solipath.bat (once it is there), and the solipath.json files over to your project.
